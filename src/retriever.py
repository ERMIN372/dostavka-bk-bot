...
# Кол-во возвращаемых чанков. Индекс небольшой (десятки чанков на весь документ),
# поэтому берём с запасом: на составных/нечётко сформулированных вопросах нужный
# фрагмент реже выпадает из контекста. Строгий системный промпт YandexGPT
# игнорирует нерелевантные фрагменты, поэтому больший top-k не повышает риск выдумок.
TOP_K = 10
